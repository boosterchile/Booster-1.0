...
// Optimized this type to reduce redundancy
export interface MockUserCredentials extends Partial<UserProfile> {
  username: string;
  password?: string;
}
...
export interface AuthContextType {
  ...
  register: (userData: MockUserCredentials) => Promise<{success: boolean; message?: string}>;
  logout: () => void;
}
